...
DEMO_SCENARIOS: list[dict] = [
    {
        ...
        "title": "Smartphone Pro Housing -- 100% Recycled Aluminum",
        "description": "See how switching to fully recycled aluminum affects the carbon footprint of a smartphone's largest component.",
        "program": "SP200",
        "component": "Housing",
    ...
    },
    {
        ...
        "title": "Laptop Enclosure -- Renewable Grid",
        "description": "What if this enclosure was manufactured using 100% renewable electricity?",
        "program": "LP400",
        "component": "Housing",
    ...
    },
    {
        ...
        "title": "Tablet Housing -- Recycled + Renewables",
        "description": "Combined impact of recycled aluminum and renewable grid on tablet housing.",
        "program": "TB300",
        "component": "Housing",
    ...
    },
    {
        ...
        "title": "Wearable Housing -- Run Full Optimization",
        "description": "Let the optimizer find the lowest carbon configuration for this wearable component.",
        "program": "WR500",
        "component": "Housing",
        "modifications": {},
        "run_optimizer": True,
